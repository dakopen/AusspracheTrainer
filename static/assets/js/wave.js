//see:https://github.com/foobar404/Wave.js/pull/40
var Wave = (function () {
    'use strict';
    function fromStream(stream, canvas_id, options = {}, connectDestination=false) {
...
this.current_stream.loop();
    ...
    var drawWeb = (functionContext) => {
        ...
        data = helper.mutateData(data, "shrink", 100);
        data = helper.mutateData(data, "split", 2)[0];
        data = helper.mutateData(data, "scale", h / 3.5); // vorher 4
        ...
        data = helper.mutateData(data, "scale", .9);
        ...
        dataCopy = helper.mutateData(dataCopy, "scale", 1.3);
